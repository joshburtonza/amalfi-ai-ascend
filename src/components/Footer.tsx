...
const Footer = () => {
  ...
  return (
    <footer className="py-16 relative bg-amalfi-black">
      {/* Separator Line */}
      ...
      <div className="max-container">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-amalfi-white/70">
                Cape Town, South Africa
              </li>
              <li>
                <a href="mailto:hello@amalfi-ai.com" className="text-amalfi-white/70 hover:text-amalfi-emerald transition-colors">
                  hello@amalfi-ai.com
                </a>
              </li>
              <li>
