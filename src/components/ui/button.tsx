  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        ...
        gradient: "btn-gradient text-primary-foreground font-semibold shadow-lg hover:shadow-xl hover:-translate-y-0.5",
        glass: "glassmorphic text-foreground hover:bg-accent/20 border-border/50",
        premium: "bg-gradient-to-r from-primary via-primary-glow to-primary text-primary-foreground font-semibold shadow-glow-md hover:shadow-glow-lg hover:-translate-y-0.5 animate-pulse-glow",
      },
      size: {
