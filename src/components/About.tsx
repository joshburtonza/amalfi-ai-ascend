      ...
      <div className="max-container relative z-10">
        <div className="glassmorphic rounded-3xl p-8 md:p-12 border border-amalfi-emerald/10 shadow-glow-sm">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold mb-10 text-gradient text-center">Who We Are</h2>
            
            <div className="space-y-6 text-amalfi-white/90">
            ...
            <div className="mt-12 flex justify-center">
              <div className="h-0.5 w-24 bg-gradient-to-r from-amalfi-emerald to-amalfi-teal rounded-full shadow-glow-sm"></div>
            </div>
          </div>
        </div>
      </div>
